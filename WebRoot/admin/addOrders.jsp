...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="ordersAction.action">订单管理</a><span class="crumb-step">&gt;</span><span>增加订单</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="userAction!register.action" method="post" id="myform" name="myform">
